...
scRNA.27522_1.infercnv.observations <- read_tsv("data/scRNA.27522_1.infercnv.observations.txt")
scRNA.27522_4.infercnv.observations <- read_tsv("data/scRNA.27522_4.infercnv.observations.txt")
scRNA.56203_1.infercnv.observations <- read_tsv("data/scRNA.56203_1.infercnv.observations.txt")
scRNA.56203_2.infercnv.observations <- read_tsv("data/scRNA.56203_2.infercnv.observations.txt")
